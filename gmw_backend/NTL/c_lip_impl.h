...
{
   _STATIC_ST _ntl_verylong tmp = 0;
...
{
   _STATIC_ST _ntl_verylong mem = 0;
   _STATIC_ST long *kmem = 0;     /* globals for Karatsuba */
   _STATIC_ST long max_kmem = 0;
...
long _ntl_zsdiv(_ntl_verylong a, long d, _ntl_verylong *bb)
{
   ...
   *bb = b;
   ...
   if ((d >= NTL_RADIX) || (d <= -NTL_RADIX)) {
      _STATIC_ST _ntl_verylong zd = 0;
      _STATIC_ST _ntl_verylong zb = 0;

      _ntl_zintoz(d, &zb);
      _ntl_zdiv(a, zb, &b, &zd);
      *bb = b;
      long res = _ntl_ztoint(zd);
...
void _ntl_zdiv(_ntl_verylong a, _ntl_verylong b, _ntl_verylong *qq, _ntl_verylong *rr)
{
   ...
   _STATIC_ST _ntl_verylong q=0, r=0;
...
{
   _STATIC_ST _ntl_verylong a = 0;
   _STATIC_ST _ntl_verylong n = 0;
   _STATIC_ST _ntl_verylong q = 0;
   _STATIC_ST _ntl_verylong w = 0;
   _STATIC_ST _ntl_verylong x = 0;
   _STATIC_ST _ntl_verylong y = 0;
   _STATIC_ST _ntl_verylong z = 0;
...
{
	_STATIC_ST _ntl_verylong u = 0;
	_STATIC_ST _ntl_verylong v = 0;
	long sgn;
...
{
	_STATIC_ST _ntl_verylong modcon = 0;
	_STATIC_ST _ntl_verylong a=0;
	_STATIC_ST _ntl_verylong b=0;
	long anegative = 0;
	long bnegative = 0;
...
/* versions of gmp prior to version 3 have really bad xgcd */
   if (_ntl_gmp_hack && 
      ...
      _STATIC_ST _ntl_verylong xa1 = 0, xb1 = 0, d1 = 0, b_red = 0;
      _STATIC_ST _ntl_verylong tmp1 = 0, tmp2 = 0, tmp3 = 0;
   ...
   )
{
   ...
   _STATIC_ST _ntl_verylong y = 0;
   _STATIC_ST _ntl_verylong z = 0;
   _STATIC_ST _ntl_verylong inv = 0;
   _STATIC_ST _ntl_verylong u = 0;
   _STATIC_ST _ntl_verylong a_bak = 0;
   _STATIC_ST _ntl_verylong n_bak = 0;
   _STATIC_ST _ntl_verylong inv_bak = 0;
   _STATIC_ST _ntl_verylong w_bak = 0;
	...
	)
{
	...
	long len_a;
	long sa;
	_STATIC_ST _ntl_verylong res = 0;
	...
	)
{
	...
	long ndiva;
	long newa;
	_STATIC_ST _ntl_verylong ln=0;
	_STATIC_ST _ntl_verylong rr=0;
...
{
	_STATIC_ST _ntl_verylong a = 0;
	_STATIC_ST _ntl_verylong ndiva = 0;
	_STATIC_ST _ntl_verylong diff = 0;
	_STATIC_ST _ntl_verylong r = 0;
	long i;
	...
	)
{
	long agrb;
	long shibl;
	_STATIC_ST _ntl_verylong aa = 0;
	_STATIC_ST _ntl_verylong bb = 0;
	_STATIC_ST _ntl_verylong cc = 0;
	_ntl_verylong a;
	_ntl_verylong b;
	_ntl_verylong c;
	_ntl_verylong d;
